const CACHE='fonely-caa-shell-v10';
const SHELL=['./caa.html','./caa-public.css?v=8','./caa-public.js?v=11','./fonely-caa-library.js?v=5','./fonely-caa-speech.js?v=4','./fonely-icon.svg','./caa-manifest.webmanifest'];

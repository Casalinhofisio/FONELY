const CACHE='fonely-caa-shell-v8';
const SHELL=['./caa.html','./caa-public.css?v=7','./caa-public.js?v=10','./fonely-caa-library.js?v=5','./fonely-caa-speech.js?v=3','./fonely-icon.svg','./caa-manifest.webmanifest'];

const CACHE='fonely-caa-shell-v1';
const SHELL=['./caa.html','./caa-public.css?v=3','./caa-public.js?v=3','./fonely-caa-library.js?v=2','./fonely-caa-speech.js?v=2','./fonely-icon.svg'];

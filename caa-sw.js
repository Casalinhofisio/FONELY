const CACHE='fonely-caa-shell-v3';
const SHELL=['./caa.html','./caa-public.css?v=4','./caa-public.js?v=5','./fonely-caa-library.js?v=3','./fonely-caa-speech.js?v=3','./fonely-icon.svg','./caa-manifest.webmanifest'];

const CACHE='fonely-caa-shell-v4';
const SHELL=['./caa.html','./caa-public.css?v=5','./caa-public.js?v=6','./fonely-caa-library.js?v=5','./fonely-caa-speech.js?v=3','./fonely-icon.svg','./caa-manifest.webmanifest'];

const CACHE='fonely-caa-shell-v7';
const SHELL=['./caa.html','./caa-public.css?v=6','./caa-public.js?v=9','./fonely-caa-library.js?v=5','./fonely-caa-speech.js?v=3','./fonely-icon.svg','./caa-manifest.webmanifest'];
